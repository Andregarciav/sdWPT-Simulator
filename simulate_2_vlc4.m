...
for itera=1:25
    ...
    save(['simulate_2nodes10_4_',num2str(itera),'.mat']);
end
...
for itera=1:25
    ...
    save(['simulate_2nodes50_4_',num2str(itera),'.mat']);
end
...
for itera=1:25
    ...
    save(['simulate_2nodes100_4_',num2str(itera),'.mat']);
end
...
for itera=1:25
    ...
    save(['simulate_2nodes200_4_',num2str(itera),'.mat']);
end
...
for itera=1:25
    ...
    save(['simulate_2nodes300_4_',num2str(itera),'.mat']);
end
...
for itera=1:25
    ...
    save(['simulate_2nodes400_4_',num2str(itera),'.mat']);
end
